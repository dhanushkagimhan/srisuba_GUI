      ...
      case ProposerStatusEnum.PendingPayment: {
        return (
          <div>
            ...
            <div className="mt-4">
              Transfer the Rs. {proposalPriceState.price ?? ""} (LKR) to
              following bank account and send the slip / screenshot and you
              email to the {systemContactNumber} via whatsApp.
            </div>
            <BankAccount />
          </div>
        );
